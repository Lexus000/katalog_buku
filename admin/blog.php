    ...
    <section class="content">
            <div class="card">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    //query sql
                    $sql_b = "SELECT blog.id_blog, kategori_blog.kategori_blog, blog.judul, blog.tanggal
                    FROM `blog` INNER JOIN `kategori_blog` ON
                    kategori_blog.id_kategori_blog=blog.id_kategori_blog"; 
                    ...
                    $sql_b .= " ORDER BY `kategori_blog` limit $posisi, $batas ";
              ...
              <?php 
                ...
                blog.judul, blog.tanggal FROM `blog` INNER JOIN `kategori_blog`
                ON kategori_blog.id_kategori_blog=blog.id_kategori_blog";
                if (isset($_GET["katakunci"])){ 
                  $katakunci = $_GET["katakunci"]; 
