    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                        ...
                        <td align="center"> 
                        <a href="editkategoribuku.php?data=<?php echo $id_kategori_buku;?>"
                        class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a> 
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>
                        ?'))window.location.href = 'kategoribuku.php?aksi=hapus&data=<?php echo $id_kategori_buku;?>
                        &notif=hapusberhasil'"class="btn btn-xs btn-warning">
              ...
              <?php 
                ...
                if (isset($_GET["katakunci"])){ 
                  $katakunci = $_GET["katakunci"]; 
                  $sql_jum .= " where `kategori_buku` LIKE '%$katakunci%'"; 
                }  
