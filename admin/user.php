              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center">
                    ...
                    <a href="detailuser.php?data=<?php echo $id_user;?>"
                    class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                    <a href="javascript:if(confirm('Anda yakin ingin menghapus user
                    <?php echo $nama; ?>?'))window.location.href = 'user.php?aksi=hapus&data=
