  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"style="margin-top:5px;"><i class="far fa-list-alt">
        </i> Form Edit Data Konten</h3>
      ...
      <form class="form-horizontal" method="post" action="konfirmasieditkonten.php">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <textarea class="form-control" name="isi" id="editor1" rows="12" required><?= $isi ?></textarea>
            </div>
          </div>     
