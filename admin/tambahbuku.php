...
<?php include("includes/header.php") ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" method="post" action="konfirmasitambahbuku.php" enctype="multipart">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <div class="input-group date">
                <input type="number" class="form-control" name="tahun_terbit" id="datepicker-year"  autocomplete="off"
                value="">
