                ...
                <table class="table table-bordered"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                       ...
                       <td><?php echo $tag;?></td> 
                       <td align="center"> 
                       <a href="edittag.php?data=<?php echo $id_tag;?>"
                       class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a> 
                       <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $tag; ?>
                       ?'))window.location.href = 'tag.php?aksi=hapus&data=<?php echo $id_tag;?>&notif=hapusberhasil'" 
