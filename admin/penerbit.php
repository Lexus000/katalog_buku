    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr> 
                       ...
                       <td align="center"> 
                       <a href="editpenerbit.php?data=<?php echo $id_penerbit;?>"
                       class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a> 
                       <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $penerbit; ?>
                       ?'))window.location.href = 'penerbit.php?aksi=hapus&data=<?php echo $id_penerbit;?>
              ...
              <?php 
                ...
                if (isset($_GET["katakunci"])){ 
                  $katakunci = $_GET["katakunci"]; 
                  $sql_jum .= " where `penerbit` or `alamat` LIKE '%$katakunci%'"; 
                }  
