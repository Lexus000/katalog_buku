    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr> 
                       ...
                       <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>
                       ?'))window.location.href = 'kategoriblog.php?aksi=hapus&data=<?php echo $id_kategori_blog;?>
              ...
              <?php 
                ...
                if (isset($_GET["katakunci"])){ 
                  $katakunci = $_GET["katakunci"]; 
                  $sql_jum .= " where `kategori_blog` LIKE '%$katakunci%'"; 
                }  
