    ...
    <section class="content">
            <div class="card">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr> 
                       ...
                       <td class="isi"><?php echo $judul;?></td>
                       <td><?php echo $kategori_buku;?></td>
                       <td class="isi"><?php echo $penerbit;?></td> 
                      ...
                      class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                       ...
                       ?'))window.location.href = 'buku.php?aksi=hapus&data=<?php echo $id_buku;?>&notif=hapusberhasil'"
              ...
              <?php 
                ...
                $sql_jum = "SELECT buku.id_buku, kategori_buku.kategori_buku, buku.judul,
                penerbit.penerbit FROM `buku` INNER JOIN `kategori_buku`
                ON kategori_buku.id_kategori_buku=buku.id_kategori_buku INNER JOIN
                `penerbit` ON penerbit.id_penerbit=buku.id_penerbit";
                if (isset($_GET["katakunci"])){ 
                  $katakunci = $_GET["katakunci"]; 
